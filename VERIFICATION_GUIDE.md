...
## 🔍 How to Verify Lottery Draws Are Fair
...
✅ **Tier 1 Winner** (40% of pot) - Exact entry number match
...
- ✅ Generated on-chain by the smart contract
- ✅ Immutable (cannot be changed after draw)
- ✅ Publicly visible on Algorand blockchain
- ✅ Created from unpredictable blockchain data
...
### 3. Compare Results
If calculated winners match registered winners → **FAIR** ✅
If they don't match → **SUSPICIOUS** ⚠️
...
- Same seed input → Same winner output (every time)
- Run verification 1,000 times → Get identical results
